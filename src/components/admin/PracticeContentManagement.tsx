...
export const PracticeContentManagement: React.FC = () => {
  ...
  const practiceQuestions = questions.filter(q => q.id.includes('practice') || !q.id.includes('exam'));
  ...
  const handleBulkUpload = () => {
    try {
      ...
      alert(`Successfully added ${addedCount} practice questions!`);
      setBulkUpload('');
  ...
  const QuestionForm: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      const questionData: Question = {
        id: editingQuestion?.id || `practice-${uuidv4()}`,
        subject: subject,
    ...
    <div>
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h3 className="text-2xl font-bold text-white mb-2">Practice Content Management</h3>
            <p className="text-gray-400">Manage practice questions for student learning</p>
          </div>
          <div className="flex space-x-2">
      ...
      {showBulkUpload && (
        <GlassCard hover={false} className="mb-6">
          <h4 className="text-lg font-semibold text-white mb-4">Bulk Upload Practice Questions</h4>
          ...
          <textarea
            ...
            className="w-full p-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
            rows={10}
            placeholder="Mathematics|Algebra|medium|What is 2+2?|3|4|5|6|2|2+2 equals 4"
          />
      ...
      <div className="mt-6">
        ...
        {practiceQuestions.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400">Start by adding your first practice question</p>
          </div>
        ) : (
